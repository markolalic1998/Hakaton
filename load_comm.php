                ...
                while ($recorddd = mysqli_fetch_array($result_show_members, MYSQLI_ASSOC)) {
                    ...
                    while ($record_m_u = mysqli_fetch_array($result_member_user, MYSQLI_ASSOC)) {
                        ...
                        if ($check_c_abs == $_SESSION['username']) {
                            ...
                            onclick="ajaxMemberAlone(<?php echo $recorddd['id_member']; ?>)">
                                ...
                                <div class="col-sm-12 member-card">
                                    <div class="col-sm-12">
                                        <img class="img-circle img-thumbnail"
                                             src="img/profile/<?php echo $record_m_u["picture"]; ?>" height="100px"
                                             width="100px"
                                             alt="Member Picture">
                                    </div>
                                    <div class="col-sm-12 member-card-info text-center">
                                        ...
                                        <span id="id_member"
                                              style="display: none;"><?php echo $recorddd["id_member"]; ?></span>
                                    </div>
                                    <?php
                                    /*
                                    $user_check = $record_m_u['username'];
                                    ...
                                    */
                                    if ($record_m_u['username'] != $check_c_abs) {
                                        if ($check_c_abs == $_SESSION['username']) {
                                            ?>
                                            <div class="col-sm-6">
                                                <i class="fas fa-angle-double-up" style="font-size: 20px;"
                                                   title="Promotion"></i>
                                            </div>
                                            <div class="col-sm-6">
                                                <i class="fas fa-user-slash" style="font-size: 20px;"
                                                   title="Remove"></i>
                                            </div>
                                            <?php
                                        } else {
